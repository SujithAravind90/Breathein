	...
	<header id="header-mobile" class="header-mobiles">
		...
		<div class="header-mobiles-menu">
			...
			<a data-toggle="MenuOffCanvas">
				<svg class="miniture-burger-menu">
			 		<use xlink:href="#miniture-burger-menu"></use>
				</svg>
			</a>
		...
		<div class="header-mobiles-actions">
			<ul class="header-act">
				...
				<li class="header-mobiles-search">
						...
						<svg class="svg-icon">
						 <use xlink:href="#miniture-search"></use>
						</svg>
					</a>
				</li>
				<?php endif; ?>
		...
		<div class="header-handheld__inner">
			...
			<div class="handheld_component handheld_component--dropdown-menu nova_compt_iem nova_com_action--dropdownmenu">
				<a rel="nofollow" class="component-target" href="javascript:;">
					<svg class="miniture-settings-bar">
					 <use xlink:href="#miniture-menu-bar"></use>
					</svg>
				</a>
			...
			<div class="handheld_component handheld_component--wishlist nova_compt_iem nova_com_action--wishlist ">
				<a rel="nofollow" class="component-target" href="<?php echo esc_url(YITH_WCWL()->get_wishlist_url()); ?>">
					<svg class="miniture-wishlist-bar">
					 <use xlink:href="#miniture-wishlist-bar"></use>
					</svg>
		...
		<?php if ( nova_get_option('header_cart', 1) == 1 ) : ?>
			<div class="handheld_component handheld_component--cart nova_compt_iem nova_com_action--cart ">
				<a rel="nofollow" class="component-target" href="javascript:;" data-toggle="MiniCartCanvas">
					<svg class="miniture-bag-bar">
					 <use xlink:href="#miniture-bag-bar"></use>
					</svg>
