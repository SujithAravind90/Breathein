...
function nova_scripts() {
	...
	if( nova_get_option('site_preloader') ) {
	...
	$nova_js_vars = array(
		...
		'js_min'        				=> true,
		'site_preloader' 				=> nova_get_option('site_preloader',0),
		'topbar_progress' 				=> nova_get_option('topbar_progress',0),
		'select_placeholder'        	=> esc_html__( 'Choose an option', 'miniture' ),
		'blog_pagination_type' 			=> nova_get_option('blog_pagination','default'),
		'load_more_btn'        			=> esc_html__( 'Load more', 'miniture' ),
		'read_more_btn'        			=> esc_html__( 'Read more', 'miniture' ),
		'read_less_btn'        			=> esc_html__( 'Read less', 'miniture' ),
