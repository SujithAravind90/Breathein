...
function nova_styles() {
	...
	wp_enqueue_style('nova-miniture-layout', get_template_directory_uri() . '/assets/css/layout.css', NULL, $theme_version, 'all');
	wp_enqueue_style('nova-miniture-styles', get_template_directory_uri() . '/assets/css/app.css', NULL, $theme_version, 'all');
...
function nova_google_fonts_url() {
		...
		if ( 'off' !== _x( 'on', 'Outfit font: on or off', 'miniture' ) ) {
