...
if ( NOVA_WOOCOMMERCE_IS_ACTIVE ) {
	...
	function woocommerce_template_loop_stock() {
	    ...
	    if ( ! $product->is_in_stock() )
	        echo '<span class="stock out-of-stock">' . esc_html__( 'Out of stock', 'miniture' ) . '</span>';
	}
				...
				<form class="header_search_form" role="search" method="get" action="' . esc_url( home_url( '/'  ) ) .'">
					...
					<div class="header_search_input_wrapper">
						<input
							...
							data-min-chars="3"
							placeholder="' . esc_attr__( 'Product Search', 'miniture' ) . '"
							/>
...
if( ! function_exists( 'nova_shop_filters' ) ){
	function nova_shop_filters() {
		...
		<div id="side-filters" class="nova-product-filter-content">
				<header>
					<h2><?php echo esc_html__( 'Filters','miniture' ); ?></h2>
					<button class="js-product-filters-toogle"><?php echo esc_html__( 'Close','miniture' ); ?></button>
				</header>
...
if( ! function_exists( 'nova_toggle_registration_login' ) ){
	function nova_toggle_registration_login($context) {
		...
		if ( $context == 'login' ) { ?>
			...
			<p class="form-actions extra"><?php esc_html_e('Already a member?', 'miniture'); ?><a href="#nova-login-wrap" class="login-link"><?php esc_html_e('Login', 'miniture'); ?></a></p>

		<?php } else if ( $context == 'register' ) { ?>

			<p class="form-actions extra"><?php esc_html_e('Not a member?', 'miniture'); ?><a href="#nova-register-wrap" class="register-link"><?php esc_html_e('Register', 'miniture'); ?></a></p>
